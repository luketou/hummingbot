...
async def start(self):
    ...
    try:
        ...
        strategy.init_params(
            ...
            maker_fee_pct=c_map.maker_fee_pct,
            assumed_exit_fee_pct=c_map.assumed_exit_fee_pct,
            fee_floor_buffer_pct=c_map.fee_floor_buffer_pct,
            ...
            stop_loss_use_maker_orders=c_map.stop_loss_use_maker_orders,
            stop_loss_maker_timeout=c_map.stop_loss_maker_timeout,
            stop_loss_auto_fallback=c_map.stop_loss_auto_fallback,
